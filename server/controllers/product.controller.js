...
module.exports.createProduct = (request, response) => {
    const {productName, price,description} = request.body; //Obtener las variables de la solicitud
    Product.create({productName, price,description})
...
module.exports.updateProduct = (request,response) => {
    Product.findOneAndUpdate({_id: request.params.id},request.body,{new:true}) //Recupera un producto de la consulta de acuerdo al ID ingresado en la URL
